...
$Path = "C:\2\ClientInventory\$newfolder\Desktops.csv"
...
Get-ADComputer  -Properties * -Filter {LastLogonDate -ge $cutoffdate} -SearchBase "dc=$domain,dc=sunbeam,dc=com" -Server $domaincontroller | Select Name,OperatingSystem,OperatingSystemVersion,LastLogonDate,CanonicalName,distinguishedname |Where-Object DistinguishedName -like "*desktop*"|Where-Object OperatingSystem -NotLike "*Server*"|Export-Csv -Path $Path -Append
