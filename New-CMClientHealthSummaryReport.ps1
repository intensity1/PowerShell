...
#region Parameters
# Database info
$script:dataSource = 'flmir-sccmsql' # SQL Server name (and instance where applicable)
$script:database = 'CM_BSG' # ConfigMgr Database name

# Email params
$EmailParams = @{
    To         = 'jose.esposito@southernwine.com',"harmas@southernwine.com"
    From       = 'SCCMReporting@sgws.com'
    Smtpserver = 'mail.southernwine.com'
